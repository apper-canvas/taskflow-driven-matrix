...
export const categoryService = {
        ...
        records: [
          {
            ...
            color_c: categoryData.color || "#5B67F5",
            taskCount_c: 0
          }
        ]
      };
  ...
  async update(id, updates) {
    try {
      ...
      if (updates.taskCount !== undefined) updateData.taskCount_c = updates.taskCount;
  ...
  async updateTaskCount(categoryName, count) {
    try {
      ...
      if (category) {
        const result = await this.update(category.Id, { taskCount: count });
        return result;
      }
